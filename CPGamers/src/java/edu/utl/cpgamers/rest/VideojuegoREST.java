...
public class VideojuegoREST extends Application
{
    ...
    public Response insertarRegistro(@QueryParam("videojuego") String v) 
    {
        ...
        try 
        {
            ...
            //Se llena al método de insertar
            int idGenerado = objCV.insertarRegistro(videojuego);
            //Se genera la respuesta del servicio que contenga el id que se generó en la inserción
            out = "{\"idGenerado\": " + idGenerado + "}";
        } 
        catch (Exception ex)
        {
            ex.printStackTrace();
